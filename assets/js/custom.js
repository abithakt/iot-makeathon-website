...
(function( $ ){
	...
	$('#mu-event-counter').countdown('2018/03/23').on('update.countdown', function(event) {
...
$(document).ready(function() {
    ...
    .on('success.form.bv', function(e) {
        ...
        var url = 'https://script.google.com/a/vitstudent.ac.in/macros/s/AKfycbzi8YSVdS385rdeXm6ppT-XKl0AB1fGNkBwHZJuQmnrEJSLoo4/exec';
